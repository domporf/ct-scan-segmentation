...
selected_masks = np.zeros(image_3D.shape)

# Initializing output dissected masks variable
dissected_mask = np.zeros(image_3D.shape)
...
#Stored times list
elapsed_times = []
print(image_3D.shape[0])
for i in range(10, image_3D.shape[0]):
